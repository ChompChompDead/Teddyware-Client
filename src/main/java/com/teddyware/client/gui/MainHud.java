    ...
    public static class ModuleComparator implements Comparator<Module> {
        ...
        public int compare(Module arg0, Module arg1) {
            if (ArrayListt.mode.is("Down")) {
                if (ArrayListt.modeInfo.isEnabled() ? FontUtil.getStringWidth(arg0.getName() + " " + arg0.getArrayListInfo()) < FontUtil.getStringWidth(arg1.getName() + " " + arg1.getArrayListInfo()) :
                ...
                for (Module mod : ModuleManager.getModuleList()) {
                    if (mod.isToggled() && !mod.hidden.isEnabled()) {
                        if (ArrayListt.modeInfo.isEnabled()) {
                            FontUtil.drawStringWithShadow(
                                mod.getName() + " " + mod.getArrayListInfo(),
                                sr.getScaledWidth() - FontUtil.getStringWidth(mod.getName() + " " + mod.getArrayListInfo()) - 2, y,
                        ...
                        y += FontUtil.getStringHeight(ArrayListt.modeInfo.isEnabled() ? mod.getName() + " " + mod.getArrayListInfo() : mod.getName());
                        counter[0]++;
                    }
